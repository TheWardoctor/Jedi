...
def select_countries():
    ...
    if result:
        ...
        countries = ','.join(ids)
        xbmcaddon.Addon(id = 'script.jedi.guide').setSetting('yo.countries',countries)


def select_providers():
    s = xbmcaddon.Addon(id = 'script.jedi.guide').getSetting('yo.countries')
    if not s:
        return
    countries = s.split(',')
    d = xbmcgui.Dialog()
    ...
    xbmcaddon.Addon(id = 'script.jedi.guide').setSetting('yo.%s.headend' % country, headend)
