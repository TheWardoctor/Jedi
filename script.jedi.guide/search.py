...
f = xbmcvfs.File('special://profile/addon_data/script.jedi.guide/favourites.xml')
data = f.read()
f.close()
if not data:
    f = xbmcvfs.File('special://home/addons/script.jedi.guide/resources/favourites.xml')
    data = f.read()
    f.close()
