...
def getCustomStreamUrls(success):
    if success:
        ...
        file_name = 'special://profile/addon_data/script.jedi.guide/custom_stream_urls.ini'
...
def getAltCustomStreamUrls(success):
    if success:
        ...
        file_name = 'special://profile/addon_data/script.jedi.guide/alt_custom_stream_urls.tsv'
        f = xbmcvfs.File(file_name,'wb')
