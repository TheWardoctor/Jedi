...
path = xbmc.translatePath('special://profile/addon_data/script.jedi.guide/source.db')
try:
...
if url:
    ...
    dialog.notification("Jedi Guide","Starting Recording",sound=True)
    ...
    dialog.notification("Jedi Guide","Finished Recording",sound=True)