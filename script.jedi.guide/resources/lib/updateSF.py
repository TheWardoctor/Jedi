...
localtxt01 = 'Install'
localtxt02 = 'Downloading Latest Jedi Guide Super Favourites...'
...
xbmc.executebuiltin('Notification(Super Favs Folders, Updated,special://home/addons/script.jedi.guide/icon.png)')
time.sleep(1)