...
path       = xbmc.translatePath('special://home/userdata/addon_data/script.jedi.guide')
lib        = xbmc.translatePath(os.path.join(path,'logos.zip'))
home       = xbmc.translatePath('special://home/userdata/addon_data/script.jedi.guide/')
profile    = 'Master user'
lock       = 'false'
...
if __name__ == '__main__':
	...
	try:
		...
		xbmc.executebuiltin('Notification(Install Failed, Try Later,special://home/addons/script.jedi.guide/icon.png)')
	time.sleep(1)


os.remove(path + "/logos.zip")
xbmc.executebuiltin('Notification(Logos, Updated,special://home/addons/script.jedi.guide/icon.png)')
time.sleep(1)
