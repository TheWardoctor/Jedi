...
path = xbmc.translatePath('special://home/addons/script.jedi.guide/resources/eventList.txt')
f = open(path, 'r+')
f.truncate()
#os.remove(path)
...
def Jedi GuideINFO():
    eventList = xbmc.translatePath('special://home/addons/script.jedi.guide/resources/eventList.txt')
