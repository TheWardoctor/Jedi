...
path       = xbmc.translatePath('special://home/addons/script.jedi.guide/resources/skins')
lib        = xbmc.translatePath(os.path.join(path,'skins.zip'))
home       = xbmc.translatePath('special://home/addons/script.jedi.guide/resources/skins')
profile    = 'Master user'
lock       = 'false'
...
if __name__ == '__main__':
	...
	try:
		...
		xbmc.executebuiltin('Notification(Install Failed, Please Try Again Later,special://home/addons/script.jedi.guide/icon.png)')
	time.sleep(1)


os.remove(path + "/skins.zip")
xbmc.executebuiltin('Notification(Skins, Updated,special://home/addons/script.jedi.guide/icon.png)')
time.sleep(1)
