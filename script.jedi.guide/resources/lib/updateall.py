...
# xbmc.executebuiltin('Notification(Please ensure that, Meta is installed,special://home/addons/script.jedi.guide/icon.png)')
# time.sleep(1)
...
if __name__ == '__main__':
	...
	try:
		...
		xbmc.executebuiltin('Notification(Download Failed,Please Try Again Later,50000,special://home/addons/script.jedi.guide/icon.png)')
	time.sleep(1)
	try:
		ExtractorClass(lib,home)
	except:
		xbmc.executebuiltin('Notification(Install Failed, Is Meta installed?,special://home/addons/script.jedi.guide/icon.png)')
	time.sleep(5)
		
os.remove(path + "/MetaPlayers.zip")
xbmc.executebuiltin('Notification(Third Party Meta Players, Installed,special://home/addons/script.jedi.guide/icon.png)')
time.sleep(1)
