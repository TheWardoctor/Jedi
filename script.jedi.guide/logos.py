...
for path in unique:
    ...
    for file in thumbnails:
        ...
        thumbs[file] = thumb
logo_folder = 'special://profile/addon_data/script.jedi.guide/addon_logos/'
for addonId in sorted(logos):
    folder = 'special://profile/addon_data/script.jedi.guide/addon_logos/%s' % addonId
...
dialog.notification("Jedi Guide","Done: Download Logos")
